...
if __name__ == '__main__':
    ...
    particle = Particle([0, -2000], 0, translation([0, 0, 500]).dot(rotation_x(- math.pi / 2)))
    particle_count = 200
    ...
    particles = [Particle([X[i], Y[i]], yaws[i], translation([0, 0, 500]).dot(rotation_x(- math.pi / 2))) for i in range(particle_count)]
